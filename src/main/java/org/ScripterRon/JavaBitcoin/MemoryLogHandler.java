...
/**
 * MemoryLogHandler maintains a ring buffer of log messages.  The GetLog RPC is used
 * to retrieve these log messages.
 *
 * The following logging.properties entries are used:
 * <ul>
 * <li>org.ScripterRon.JavaBitcoin.MemoryLogHandler.level (default ALL)</li>
 * <li>org.ScripterRon.JavaBitcoin.MemoryLogHandler.size (default 100, minimum 10)</li>
 * </ul>
 */
