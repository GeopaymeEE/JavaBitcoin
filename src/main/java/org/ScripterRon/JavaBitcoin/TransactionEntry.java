...
/**
 * The LevelDB TxOutputs table contains an entry for each transaction with an unspent output.
 * The key is a TransactionID and the value is a TransactionEntry.
 *
